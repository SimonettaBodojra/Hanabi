...
class RuleManager:
    ...
    def __init__(self, state):
        ...
        self.rules_dict = {
            ...
            22: PlayUsefulCard(state, usefulness_threshold=0.5),
            23: DiscardDispensableCard(state, dispensable_threshold=0.3)
        }
    ...
    def two_players_if_strategy(self):
